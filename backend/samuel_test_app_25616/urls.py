"""samuel_test_app_25616 URL Configuration
...
admin.site.site_header = "samuel-test-app"
admin.site.site_title = "samuel-test-app Admin Portal"
admin.site.index_title = "samuel-test-app Admin"

# swagger
api_info = openapi.Info(
    title="samuel-test-app API",
    default_version="v1",
    description="API documentation for samuel-test-app App",
)
